...
void setup() {
    ...
    // Temp ring
    int tempValue = 50;
    lv_obj_t *tempArc = CreateBaseArc(0xFFD72749, 230, 0, 100, 100, 170);
    lv_arc_set_value(tempArc, tempValue);
    lv_obj_remove_style(tempArc, NULL, LV_PART_KNOB);                             // Remove knob
    lv_obj_set_style_arc_color(tempArc, lv_color_hex(0xFFD72749), LV_PART_MAIN);  // Main color
    lv_obj_t *tempSymbol = lv_label_create(lv_scr_act());                         //
    lv_obj_align(tempSymbol, LV_ALIGN_CENTER, 0, 106);                            // Center position
    ...
    // Volt ring
    lv_obj_t *voltArc = CreateBaseArc(0xFFD89843, 230, 0, 15, 190, 260);
    ...
    // Arc 3
    lv_obj_t *arc3 = CreateBaseArc(0xFF18BB8D, 230, 0, 100, 280, 350);
    ...
    lv_obj_align(mountainSymbol, LV_ALIGN_CENTER, 0, -108);                    // Center position
    ...
    // Arc 4
    lv_obj_t *arc4 = CreateBaseArc(0xFF3654F5, 230, 0, 100, 10, 80);
    ...
    lv_obj_set_style_text_color(cloudMoonSymbol, lv_color_hex(0xFF3654F5), 0);  // Change text color
